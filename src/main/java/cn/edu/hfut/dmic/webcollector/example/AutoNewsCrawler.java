...
public class AutoNewsCrawler extends BreadthCrawler {
    ...
    public AutoNewsCrawler(String crawlPath, boolean autoParse) {
        ...
        //this.addSeed("http://www.hotelaah.com/liren/index.html");
        this.addSeed("http://www.hotelaah.com/liren/anhui.html");
...
//        setResumable(true);
    ...
    public void visit(Page page, CrawlDatums next) {
        ...
        if (page.matchUrl("http://www.hotelaah.com/liren/anhui.html")) {
